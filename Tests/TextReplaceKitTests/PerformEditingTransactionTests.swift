...
struct ReplaceAndAdjustSelectedTextRangeTests {
    ...
    func replace() async throws {
        ...
        textView.replaceAndAdjustSelectedTextRange(
            textView.documentRange,
            withAttributedText: NSAttributedString(string: "🐈")
        )
    ...
    func replace6() async throws {
        ...
        textView.replaceAndAdjustSelectedTextRange(
            textView.textRange(location: 6, length: 7)!,
            withAttributedText: NSAttributedString(string: "🐈")
        )
...
struct ReplaceAndAdjustSelectedTextRangeTests2 {
    ...
    func replace() async throws {
        ...
        textView.replaceAndAdjustSelectedTextRange(
            textView.documentRange,
            withAttributedText: NSAttributedString(string: ":cat:")
        )
    ...
    func replace6() async throws {
        ...
        #expect(textView.visualText == "head[er🐈foo]ter")
        textView.replaceAndAdjustSelectedTextRange(
            textView.textRange(location: 6, length: 2)!,
            withAttributedText: NSAttributedString(string: ":cat:")
        )
